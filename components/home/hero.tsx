    ...
    <section className="border-b border-border bg-gradient-to-b from-muted to-background">
      <div className="mx-auto grid max-w-site items-center gap-8 px-4 py-12 md:grid-cols-[300px_1fr] md:py-16">
        ...
        <div className="text-center md:text-left">
          ...
          {quote && (
            <blockquote className="mx-auto mt-6 max-w-xl border-l-4 border-secondary pl-4 text-left md:mx-0">
              <p className="font-serif text-lg italic leading-relaxed text-text">
                «{quote}»
              </p>
              {quoteAuthor && (
                <footer className="mt-2 text-sm text-text-muted">— {quoteAuthor}</footer>
              )}
            </blockquote>
          )}
